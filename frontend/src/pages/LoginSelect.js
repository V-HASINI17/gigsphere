    ...
    <div className="min-h-screen bg-slate-50 dark:bg-brand-dark flex flex-col justify-center items-center p-6 relative overflow-hidden transition-colors duration-300">
      ...
      >
        ...
        <div className="text-center space-y-3 mb-12 mt-4">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Select your account type to proceed to login</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed px-4">Find hyperlocal gigs, apply with verification, and track earnings</p>
            </div>
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed px-4">Post flexible jobs, manage applicants, and rate gig completions</p>
            </div>
          ...
          >
            ...
            <div className="space-y-1">
              <h3 className="font-bold text-lg text-slate-800 dark:text-slate-100 group-hover:text-amber-500 transition-colors">Administrator</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed px-4">Verify IDs, manage users, review reports, and analyze stats</p>
            </div>
        ...
        <div className="text-center mt-10 text-xs text-slate-400 font-medium">
          ...
          <span onClick={() => navigate("/signup")} className="text-indigo-500 hover:underline cursor-pointer">
            Create an account
          </span>
        </div>
      </motion.div>
